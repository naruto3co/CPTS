...
Nó hỏi thằng damundsen ở nhóm Help Desk Level 1 có những quyền gì 

```
Import-Module .\PowerView.ps1
PS C:\Tools> $sid = Convert-NameToSid damundsen
PS C:\Tools> Get-DomainObjectACL -ResolveGUIDs -Identity "Help Desk Level 1" |
...
AceQualifier          : AccessAllowed
```
-> đáp án là  ListChildren, ReadProperty, GenericWrite
...
Thằng này hỏi dpayne nó có những quyền gì. Phần này phải filter bé 1 xíu không thì treo mẹ máy luôn vì nhiều kết quả quá 
```
$sid_forend = Convert-NameToSid forend
Get-DomainObjectACL -ResolveGUIDs -Identity dpayne | Where-Object { $_.SecurityIdentifier -eq $sid_forend } | Select-Object ObjectDN, ActiveDirectoryRights, ObjectAceType, AceType
```
